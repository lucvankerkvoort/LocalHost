      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="relative">
          {image ? (
            ...
            <div className="w-16 h-16 rounded-full bg-[var(--sunset-orange)] text-white flex items-center justify-center text-xl font-semibold">
              {initials}
            </div>
          )}
          {/* Verified badge */}
          {verificationTier !== 'BASIC' && (
            <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-[var(--forest-green)] rounded-full flex items-center justify-center">
